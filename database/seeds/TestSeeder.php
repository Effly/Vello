...
class TestSeeder extends Seeder
{
     ...
     */
    public function run()
    {   //отрубить product_list
        $categories = json_decode(file_get_contents('D:\op\OSPanel\domains\parse\Categories\Categories.json'), true);
        foreach ($categories as $category) {
            foreach ($category as $item => $link) {
//  1ая категория
                if (stristr($link, "/product_list/")) {
...
//  2ая категория
        $categories = json_decode(file_get_contents('D:\op\OSPanel\domains\parse\Categories\secCategories.json'), true);
        foreach ($categories as $category) {
            foreach ($category as $item => $link) {
                if (stristr($link, "/product_list/zapchasti-pogruzchikov/")) {
                    DB::table('categories')->insert([
                        'parent_id' => 1,
                        'name' => $item,
                        'seo' => '',
                ...
                } elseif (stristr($link, "/product_list/zapchasti-dvigateley/")) {
                    DB::table('categories')->insert([
                        'parent_id' => 2,
                        'name' => $item,
                        'seo' => '',
                ...
                } elseif (stristr($link, "/product_list/shiny-diski/")) {
                    DB::table('categories')->insert([
                        'parent_id' => 3,
                        'name' => $item,
                        'seo' => '',
                ...
                } elseif (stristr($link, "/product_list/zapchasti-dlya-gidrobortov/")) {
                    DB::table('categories')->insert([
                        'parent_id' => 4,
                        'name' => $item,
                        'seo' => '',
                ...
                } elseif (stristr($link, "/product_list/zapchasti-dlya-dizelnykh-generatorov/")) {
                    DB::table('categories')->insert([
                        'parent_id' => 5,
                        'name' => $item,
                        'seo' => '',
...
//3я категория
        $categories = json_decode(file_get_contents('D:\op\OSPanel\domains\parse\Categories\thirdCategories.json'), true);
        foreach ($categories as $category) {
            foreach ($category as $item => $link) {
